        ...
        <div style={{ padding: '2rem', overflowY: 'auto', flex: 1, color: 'var(--text-secondary)', lineHeight: '1.6', fontSize: '0.95rem' }}>
          ...
          {isAuthor ? (
            <>
              ...
              <h3 style={{ color: 'var(--text-main)', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '0.5rem', marginTop: '1.5rem' }}>4. Privacidade (LGPD) e Rescisão</h3>
            ...
            <>
              ...
              <h3 style={{ color: 'var(--text-main)', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '0.5rem', marginTop: '1.5rem' }}>3. Privacidade e Proteção de Dados (LGPD)</h3>
