    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <h2 style={{ fontFamily: "'Playfair Display', serif", color: 'var(--text-main)', margin: 0 }}>Painel de Ideias</h2>
        ...
        <div style={{ 
          ...
          {ideas.length === 0 ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '400px', color: 'var(--text-muted)' }}>
              ...
              <p style={{ margin: '0 0 1rem 0', fontSize: '1.1rem' }}>Seu quadro de ideias está vazio.</p>
